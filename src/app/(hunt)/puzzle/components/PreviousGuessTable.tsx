                ...
                <TableCell className="w-24 text-center">
                  {guess.isCorrect ? (
                    ...
                    <div className="group relative">
                      ...
                      <span className="bg-tooltip-bg pointer-events-none absolute -bottom-7 left-1/2 z-10 w-max -translate-x-1/2 rounded px-2 py-1 text-xs font-medium text-main-text opacity-0 transition-opacity group-hover:opacity-100">
                        <div className="border-b-tooltip-bg absolute -top-1 left-1/2 h-0 w-0 -translate-x-1/2 border-b-4 border-l-4 border-r-4 border-transparent" />
                        {partialSolutions[guess.guess]}
                      </span>
                    </div>
                  ) : (
